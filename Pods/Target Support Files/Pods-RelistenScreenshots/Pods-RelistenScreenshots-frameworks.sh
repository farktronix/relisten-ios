...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../../couchbase-lite-ios/frameworks/CBL Swift/iOS/CouchbaseLiteSwift.framework"
  install_dsym "${PODS_ROOT}/../../couchbase-lite-ios/frameworks/CBL Swift/iOS/CouchbaseLiteSwift.framework.dSYM"
