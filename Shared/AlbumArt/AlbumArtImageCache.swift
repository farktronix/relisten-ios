...
class AlbumArtImageCache : NSObject, FICImageCacheDelegate {
    ...
    static private let yearColors : [UIColor] = [
                                     AppColors.flatBlackColor,
                                     AppColors.flatBlueColor,
                                     AppColors.flatBrownColor,
                                     AppColors.flatCoffeeColor,
                                     AppColors.flatForestGreenColor,
                                     AppColors.flatGrayColor,
                                     AppColors.flatGreenColor,
                                     AppColors.flatLimeColor,
                                     AppColors.flatMagentaColor,
                                     AppColors.flatMaroonColor,
                                     AppColors.flatMintColor,
                                     AppColors.flatNavyBlueColor,
                                     AppColors.flatOrangeColor,
                                     AppColors.flatPinkColor,
                                     AppColors.flatPlumColor,
                                     AppColors.flatPowderBlueColor,
                                     AppColors.flatPurpleColor,
                                     AppColors.flatRedColor,
                                     AppColors.flatSandColor,
                                     AppColors.flatSkyBlueColor,
                                     AppColors.flatTealColor,
                                     AppColors.flatWatermelonColor,
                                     AppColors.flatWhiteColor,
                                     AppColors.flatYellowColor,
                                     AppColors.flatBlackColorDark,
                                     AppColors.flatBlueColorDark,
                                     AppColors.flatBrownColorDark,
                                     AppColors.flatCoffeeColorDark,
                                     AppColors.flatForestGreenColorDark,
                                     AppColors.flatGrayColorDark,
                                     AppColors.flatGreenColorDark,
                                     AppColors.flatLimeColorDark,
                                     AppColors.flatMagentaColorDark,
                                     AppColors.flatMaroonColorDark,
                                     AppColors.flatMintColorDark,
                                     AppColors.flatNavyBlueColorDark,
                                     AppColors.flatOrangeColorDark,
                                     AppColors.flatPinkColorDark,
                                     AppColors.flatPlumColorDark,
                                     AppColors.flatPowderBlueColorDark,
                                     AppColors.flatPurpleColorDark,
                                     AppColors.flatRedColorDark,
                                     AppColors.flatSandColorDark,
                                     AppColors.flatSkyBlueColorDark,
                                     AppColors.flatTealColorDark,
                                     AppColors.flatWatermelonColorDark,
                                     AppColors.flatWhiteColorDark,
                                     AppColors.flatYellowColorDark
    ]
